...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multiply_matrices.autotvin.dat"
	set constFileTvOut       "multiply_matrices.autotvout.dat"
	set constFileHdlTvIn     "multiply_matrices.autohdltvin.dat"
	set constFileHdlTvOut    "multiply_matrices.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
