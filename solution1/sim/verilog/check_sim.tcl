...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.multiply_matrices.autotvin_n.dat"
         "c.multiply_matrices.autotvin_a.dat"
         "c.multiply_matrices.autotvin_b.dat"
         "c.multiply_matrices.autotvin_c.dat"
         "c.multiply_matrices.autotvout_c.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.multiply_matrices.autotvout_c.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
