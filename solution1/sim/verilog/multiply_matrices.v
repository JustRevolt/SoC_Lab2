...
wire  signed [6:0] trunc_ln19_fu_168_p1;
reg  signed [6:0] trunc_ln19_reg_285;
wire   [3:0] i_fu_181_p2;
reg   [3:0] i_reg_294;
wire    ap_CS_fsm_state2;
wire   [6:0] mul_ln19_fu_191_p2;
reg   [6:0] mul_ln19_reg_299;
...
wire   [0:0] icmp_ln18_fu_223_p2;
wire   [6:0] add_ln19_2_fu_244_p2;
reg   [6:0] add_ln19_2_reg_332;
...
wire   [63:0] zext_ln19_fu_239_p1;
wire   [63:0] zext_ln19_1_fu_254_p1;
wire   [63:0] zext_ln22_fu_263_p1;
wire   [0:0] icmp_ln13_fu_150_p2;
wire   [0:0] icmp_ln13_1_fu_156_p2;
wire   [15:0] zext_ln14_fu_172_p1;
wire   [3:0] mul_ln19_fu_191_p0;
wire   [15:0] zext_ln15_fu_196_p1;
wire   [15:0] zext_ln18_fu_215_p1;
wire   [6:0] zext_ln18_1_fu_219_p1;
wire   [6:0] add_ln19_fu_234_p2;
wire   [6:0] add_ln19_1_fu_249_p2;
wire   [6:0] add_ln22_fu_259_p2;
reg   [5:0] ap_NS_fsm;
wire   [6:0] mul_ln19_fu_191_p00;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln18_fu_223_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        phi_mul_reg_139 <= add_ln19_2_reg_332;
    end else if (((icmp_ln15_fu_204_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln18_fu_223_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        add_ln19_2_reg_332 <= add_ln19_2_fu_244_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln14_fu_176_p2 == 1'd0) & (1'd1 == and_ln13_reg_281) & (1'b1 == ap_CS_fsm_state2))) begin
        mul_ln19_reg_299 <= mul_ln19_fu_191_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'd1 == and_ln13_fu_162_p2) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        trunc_ln19_reg_285 <= trunc_ln19_fu_168_p1;
    end
end
...
assign a_address0 = zext_ln19_fu_239_p1;

assign add_ln19_1_fu_249_p2 = (phi_mul_reg_139 + zext_ln15_1_reg_305);

assign add_ln19_2_fu_244_p2 = ($signed(phi_mul_reg_139) + $signed(trunc_ln19_reg_285));

assign add_ln19_fu_234_p2 = (mul_ln19_reg_299 + zext_ln18_1_fu_219_p1);

assign add_ln22_fu_259_p2 = (mul_ln19_reg_299 + zext_ln15_1_reg_305);
...
assign b_address0 = zext_ln19_1_fu_254_p1;

assign c_address0 = zext_ln22_fu_263_p1;
...
assign icmp_ln18_fu_223_p2 = ((zext_ln18_fu_215_p1 == n) ? 1'b1 : 1'b0);

assign j_fu_209_p2 = (j_0_reg_104 + 4'd1);

assign k_fu_228_p2 = (k_0_reg_115 + 4'd1);

assign mul_ln19_fu_191_p0 = mul_ln19_fu_191_p00;

assign mul_ln19_fu_191_p00 = i_0_reg_93;

assign mul_ln19_fu_191_p2 = ($signed({{1'b0}, {mul_ln19_fu_191_p0}}) * $signed(trunc_ln19_reg_285));

assign trunc_ln19_fu_168_p1 = n[6:0];
...
assign zext_ln18_1_fu_219_p1 = k_0_reg_115;

assign zext_ln18_fu_215_p1 = k_0_reg_115;

assign zext_ln19_1_fu_254_p1 = add_ln19_1_fu_249_p2;

assign zext_ln19_fu_239_p1 = add_ln19_fu_234_p2;

assign zext_ln22_fu_263_p1 = add_ln22_fu_259_p2;
