...
if {[file isfile multiply_matrices.autotvin.dat]} {
	file delete -force multiply_matrices.autotvin.dat
}

if {[file isfile multiply_matrices.autotvout.dat]} {
	file delete -force multiply_matrices.autotvout.dat
}
