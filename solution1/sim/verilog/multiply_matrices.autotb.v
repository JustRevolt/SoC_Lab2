...
`define AUTOTB_DUT      multiply_matrices
`define AUTOTB_DUT_INST AESL_inst_multiply_matrices
`define AUTOTB_TOP      apatb_multiply_matrices_top
`define AUTOTB_LAT_RESULT_FILE "multiply_matrices.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "multiply_matrices.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_multiply_matrices_top
...
`define AUTOTB_TVIN_n_out_wrapc  "../tv/rtldatafile/rtl.multiply_matrices.autotvin_n.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.multiply_matrices.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "../tv/rtldatafile/rtl.multiply_matrices.autotvin_b.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.multiply_matrices.autotvin_c.dat"
`define AUTOTB_TVOUT_c  "../tv/cdatafile/c.multiply_matrices.autotvout_c.dat"
`define AUTOTB_TVOUT_c_out_wrapc  "../tv/rtldatafile/rtl.multiply_matrices.autotvout_c.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 6;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 3221;
