...
// ==============================================================
#ifndef __multiply_matricesbkb__HH__
#define __multiply_matricesbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(multiply_matricesbkb) {
    ...
    SC_CTOR(multiply_matricesbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
